...
/* Tunables */
static const int sync_read_expire = 500;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 1500;	/* max time before a write sync is submitted. */
static const int async_read_expire = 500;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 1500;	/* ditto for write async, these limits are SOFT! */
static const int fifo_batch = 40;		/* # of sequential requests treated as one by the above parameters. */
