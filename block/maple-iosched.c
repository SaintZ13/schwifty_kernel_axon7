...
static const int sync_write_expire = 400;	/* max time before a write sync is submitted. */
...
static const int fifo_batch = 25;		/* # of sequential requests treated as one by the above parameters. */
